...
public class SAPServiceManager {
    ...
    EAM_NTF_CREATE_Entities eAM_NTF_CREATE_Entities;
    public static final String CONNECTION_ID_EAM_NTF_CREATE_ENTITIES = "noticreate";
    ...
    public void openODataStore(Action0 callback) {
        if (appConfig != null) {
            ...
            provider = new OnlineODataProvider("SAPService", serviceUrl + CONNECTION_ID_EAM_NTF_CREATE_ENTITIES);
            ...
            eAM_NTF_CREATE_Entities = new EAM_NTF_CREATE_Entities(provider);
    ...
    public String getServiceRoot() {
        if (serviceRoot == null) {
            if (eAM_NTF_CREATE_Entities == null) {
                throw new IllegalStateException("SAPServiceManager was not initialized");
            }
            provider = (OnlineODataProvider)eAM_NTF_CREATE_Entities.getProvider();
    ...
    public EAM_NTF_CREATE_Entities getEAM_NTF_CREATE_Entities() {
        if (eAM_NTF_CREATE_Entities == null) {
            throw new IllegalStateException("SAPServiceManager was not initialized");
        }
        return eAM_NTF_CREATE_Entities;
    }
