 ...
 * - {@link TechnicalObjectSetCreateFragment}: to create or edit a(n) TechnicalObject,
 * - {@link TechnicalObjectSetDetailFragment}: to display the details of a(n) TechnicalObject,
 * - {@link TechnicalObjectSetListFragment}: to list TechnicalObjectSet.
 *
 ...
 * what to do.
 */
public class TechnicalObjectSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<TechnicalObject> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link TechnicalObjectSetListFragment} is
     * getting instantiated (which will load {@link TechnicalObjectSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TechnicalObjectSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable TechnicalObject entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        TechnicalObjectSetCreateFragment fragment = new TechnicalObjectSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable TechnicalObject entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TechnicalObjectSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new TechnicalObjectSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable TechnicalObject entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link TechnicalObjectSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((TechnicalObjectSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            TechnicalObjectViewModel viewModel = new ViewModelProvider(getActivity()).get(TechnicalObjectViewModel.class);
