 ...
 * - {@link NotificationImageTypeCollectionCreateFragment}: to create or edit a(n) NotificationImageType,
 * - {@link NotificationImageTypeCollectionDetailFragment}: to display the details of a(n) NotificationImageType,
 * - {@link NotificationImageTypeCollectionListFragment}: to list NotificationImageTypeCollection.
 *
 ...
 * what to do.
 */
public class NotificationImageTypeCollectionActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<NotificationImageType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link NotificationImageTypeCollectionListFragment} is
     * getting instantiated (which will load {@link NotificationImageTypeCollectionDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationImageTypeCollectionListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable NotificationImageType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        NotificationImageTypeCollectionCreateFragment fragment = new NotificationImageTypeCollectionCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable NotificationImageType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationImageTypeCollectionDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new NotificationImageTypeCollectionDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable NotificationImageType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link NotificationImageTypeCollectionCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((NotificationImageTypeCollectionActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            NotificationImageTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(NotificationImageTypeViewModel.class);
