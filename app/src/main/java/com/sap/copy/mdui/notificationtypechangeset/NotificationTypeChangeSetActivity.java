 ...
 * - {@link NotificationTypeChangeSetCreateFragment}: to create or edit a(n) NotificationTypeChange,
 * - {@link NotificationTypeChangeSetDetailFragment}: to display the details of a(n) NotificationTypeChange,
 * - {@link NotificationTypeChangeSetListFragment}: to list NotificationTypeChangeSet.
 *
 ...
 * what to do.
 */
public class NotificationTypeChangeSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<NotificationTypeChange> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link NotificationTypeChangeSetListFragment} is
     * getting instantiated (which will load {@link NotificationTypeChangeSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationTypeChangeSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable NotificationTypeChange entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        NotificationTypeChangeSetCreateFragment fragment = new NotificationTypeChangeSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable NotificationTypeChange entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationTypeChangeSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new NotificationTypeChangeSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable NotificationTypeChange entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link NotificationTypeChangeSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((NotificationTypeChangeSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            NotificationTypeChangeViewModel viewModel = new ViewModelProvider(getActivity()).get(NotificationTypeChangeViewModel.class);
