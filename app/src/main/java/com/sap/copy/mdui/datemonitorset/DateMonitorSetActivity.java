 ...
 * - {@link DateMonitorSetCreateFragment}: to create or edit a(n) DateMonitor,
 * - {@link DateMonitorSetDetailFragment}: to display the details of a(n) DateMonitor,
 * - {@link DateMonitorSetListFragment}: to list DateMonitorSet.
 *
 ...
 * what to do.
 */
public class DateMonitorSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<DateMonitor> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link DateMonitorSetListFragment} is
     * getting instantiated (which will load {@link DateMonitorSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DateMonitorSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable DateMonitor entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        DateMonitorSetCreateFragment fragment = new DateMonitorSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable DateMonitor entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DateMonitorSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new DateMonitorSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable DateMonitor entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link DateMonitorSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((DateMonitorSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            DateMonitorViewModel viewModel = new ViewModelProvider(getActivity()).get(DateMonitorViewModel.class);
