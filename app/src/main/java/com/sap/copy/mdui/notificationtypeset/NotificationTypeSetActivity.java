 ...
 * - {@link NotificationTypeSetCreateFragment}: to create or edit a(n) NotificationType,
 * - {@link NotificationTypeSetDetailFragment}: to display the details of a(n) NotificationType,
 * - {@link NotificationTypeSetListFragment}: to list NotificationTypeSet.
 *
 ...
 * what to do.
 */
public class NotificationTypeSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<NotificationType> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link NotificationTypeSetListFragment} is
     * getting instantiated (which will load {@link NotificationTypeSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationTypeSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable NotificationType entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        NotificationTypeSetCreateFragment fragment = new NotificationTypeSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable NotificationType entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationTypeSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new NotificationTypeSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable NotificationType entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link NotificationTypeSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((NotificationTypeSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            NotificationTypeViewModel viewModel = new ViewModelProvider(getActivity()).get(NotificationTypeViewModel.class);
