 ...
 * - {@link PMUserDetailsSetCreateFragment}: to create or edit a(n) PMUserDetails,
 * - {@link PMUserDetailsSetDetailFragment}: to display the details of a(n) PMUserDetails,
 * - {@link PMUserDetailsSetListFragment}: to list PMUserDetailsSet.
 *
 ...
 * what to do.
 */
public class PMUserDetailsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PMUserDetails> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PMUserDetailsSetListFragment} is
     * getting instantiated (which will load {@link PMUserDetailsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PMUserDetailsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PMUserDetails entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PMUserDetailsSetCreateFragment fragment = new PMUserDetailsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PMUserDetails entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PMUserDetailsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PMUserDetailsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PMUserDetails entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PMUserDetailsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PMUserDetailsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PMUserDetailsViewModel viewModel = new ViewModelProvider(getActivity()).get(PMUserDetailsViewModel.class);
