...
/**
 * A fragment representing a single MyNotification detail screen.
 * This fragment is contained in an MyNotificationSetActivity.
 */
public class MyNotificationSetDetailFragment extends InterfacedFragment<MyNotification> {
