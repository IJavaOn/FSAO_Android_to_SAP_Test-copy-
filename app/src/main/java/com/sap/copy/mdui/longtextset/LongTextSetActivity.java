 ...
 * - {@link LongTextSetCreateFragment}: to create or edit a(n) LongText,
 * - {@link LongTextSetDetailFragment}: to display the details of a(n) LongText,
 * - {@link LongTextSetListFragment}: to list LongTextSet.
 *
 ...
 * what to do.
 */
public class LongTextSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<LongText> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link LongTextSetListFragment} is
     * getting instantiated (which will load {@link LongTextSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable LongText entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        LongTextSetCreateFragment fragment = new LongTextSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable LongText entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new LongTextSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new LongTextSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable LongText entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link LongTextSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((LongTextSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            LongTextViewModel viewModel = new ViewModelProvider(getActivity()).get(LongTextViewModel.class);
