 ...
 * - {@link MalfunctionEffectSetCreateFragment}: to create or edit a(n) MalfunctionEffect,
 * - {@link MalfunctionEffectSetDetailFragment}: to display the details of a(n) MalfunctionEffect,
 * - {@link MalfunctionEffectSetListFragment}: to list MalfunctionEffectSet.
 *
 ...
 * what to do.
 */
public class MalfunctionEffectSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MalfunctionEffect> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link MalfunctionEffectSetListFragment} is
     * getting instantiated (which will load {@link MalfunctionEffectSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MalfunctionEffectSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable MalfunctionEffect entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        MalfunctionEffectSetCreateFragment fragment = new MalfunctionEffectSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable MalfunctionEffect entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new MalfunctionEffectSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new MalfunctionEffectSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable MalfunctionEffect entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link MalfunctionEffectSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((MalfunctionEffectSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            MalfunctionEffectViewModel viewModel = new ViewModelProvider(getActivity()).get(MalfunctionEffectViewModel.class);
