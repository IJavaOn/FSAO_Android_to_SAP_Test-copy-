 ...
 * - {@link TOFacetFilterSetCreateFragment}: to create or edit a(n) TOFacetFilter,
 * - {@link TOFacetFilterSetDetailFragment}: to display the details of a(n) TOFacetFilter,
 * - {@link TOFacetFilterSetListFragment}: to list TOFacetFilterSet.
 *
 ...
 * what to do.
 */
public class TOFacetFilterSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<TOFacetFilter> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link TOFacetFilterSetListFragment} is
     * getting instantiated (which will load {@link TOFacetFilterSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TOFacetFilterSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable TOFacetFilter entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        TOFacetFilterSetCreateFragment fragment = new TOFacetFilterSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable TOFacetFilter entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TOFacetFilterSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new TOFacetFilterSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable TOFacetFilter entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link TOFacetFilterSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((TOFacetFilterSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            TOFacetFilterViewModel viewModel = new ViewModelProvider(getActivity()).get(TOFacetFilterViewModel.class);
