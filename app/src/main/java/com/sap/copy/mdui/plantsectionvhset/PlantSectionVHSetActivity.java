 ...
 * - {@link PlantSectionVHSetCreateFragment}: to create or edit a(n) PlantSectionVH,
 * - {@link PlantSectionVHSetDetailFragment}: to display the details of a(n) PlantSectionVH,
 * - {@link PlantSectionVHSetListFragment}: to list PlantSectionVHSet.
 *
 ...
 * what to do.
 */
public class PlantSectionVHSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PlantSectionVH> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PlantSectionVHSetListFragment} is
     * getting instantiated (which will load {@link PlantSectionVHSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PlantSectionVHSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PlantSectionVH entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PlantSectionVHSetCreateFragment fragment = new PlantSectionVHSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PlantSectionVH entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PlantSectionVHSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PlantSectionVHSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PlantSectionVH entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PlantSectionVHSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PlantSectionVHSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PlantSectionVHViewModel viewModel = new ViewModelProvider(getActivity()).get(PlantSectionVHViewModel.class);
