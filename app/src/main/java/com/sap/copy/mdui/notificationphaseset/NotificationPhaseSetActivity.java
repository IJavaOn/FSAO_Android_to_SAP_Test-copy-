 ...
 * - {@link NotificationPhaseSetCreateFragment}: to create or edit a(n) NotificationPhase,
 * - {@link NotificationPhaseSetDetailFragment}: to display the details of a(n) NotificationPhase,
 * - {@link NotificationPhaseSetListFragment}: to list NotificationPhaseSet.
 *
 ...
 * what to do.
 */
public class NotificationPhaseSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<NotificationPhase> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link NotificationPhaseSetListFragment} is
     * getting instantiated (which will load {@link NotificationPhaseSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationPhaseSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable NotificationPhase entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        NotificationPhaseSetCreateFragment fragment = new NotificationPhaseSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable NotificationPhase entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new NotificationPhaseSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new NotificationPhaseSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable NotificationPhase entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link NotificationPhaseSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((NotificationPhaseSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            NotificationPhaseViewModel viewModel = new ViewModelProvider(getActivity()).get(NotificationPhaseViewModel.class);
