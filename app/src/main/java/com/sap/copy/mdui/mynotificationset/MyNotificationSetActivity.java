 ...
 * - {@link MyNotificationSetCreateFragment}: to create or edit a(n) MyNotification,
 * - {@link MyNotificationSetDetailFragment}: to display the details of a(n) MyNotification,
 * - {@link MyNotificationSetListFragment}: to list MyNotificationSet.
 *
 ...
 * what to do.
 */
public class MyNotificationSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<MyNotification> {
