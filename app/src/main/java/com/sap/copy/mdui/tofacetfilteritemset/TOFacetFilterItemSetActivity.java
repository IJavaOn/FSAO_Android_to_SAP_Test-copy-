 ...
 * - {@link TOFacetFilterItemSetCreateFragment}: to create or edit a(n) TOFacetFilterItem,
 * - {@link TOFacetFilterItemSetDetailFragment}: to display the details of a(n) TOFacetFilterItem,
 * - {@link TOFacetFilterItemSetListFragment}: to list TOFacetFilterItemSet.
 *
 ...
 * what to do.
 */
public class TOFacetFilterItemSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<TOFacetFilterItem> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link TOFacetFilterItemSetListFragment} is
     * getting instantiated (which will load {@link TOFacetFilterItemSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TOFacetFilterItemSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable TOFacetFilterItem entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        TOFacetFilterItemSetCreateFragment fragment = new TOFacetFilterItemSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable TOFacetFilterItem entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TOFacetFilterItemSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new TOFacetFilterItemSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable TOFacetFilterItem entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link TOFacetFilterItemSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((TOFacetFilterItemSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            TOFacetFilterItemViewModel viewModel = new ViewModelProvider(getActivity()).get(TOFacetFilterItemViewModel.class);
