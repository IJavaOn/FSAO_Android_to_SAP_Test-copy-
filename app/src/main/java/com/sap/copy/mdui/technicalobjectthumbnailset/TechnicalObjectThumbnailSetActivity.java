 ...
 * - {@link TechnicalObjectThumbnailSetCreateFragment}: to create or edit a(n) TechnicalObjectThumbnail,
 * - {@link TechnicalObjectThumbnailSetDetailFragment}: to display the details of a(n) TechnicalObjectThumbnail,
 * - {@link TechnicalObjectThumbnailSetListFragment}: to list TechnicalObjectThumbnailSet.
 *
 ...
 * what to do.
 */
public class TechnicalObjectThumbnailSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<TechnicalObjectThumbnail> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link TechnicalObjectThumbnailSetListFragment} is
     * getting instantiated (which will load {@link TechnicalObjectThumbnailSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TechnicalObjectThumbnailSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable TechnicalObjectThumbnail entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        TechnicalObjectThumbnailSetCreateFragment fragment = new TechnicalObjectThumbnailSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable TechnicalObjectThumbnail entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TechnicalObjectThumbnailSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new TechnicalObjectThumbnailSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable TechnicalObjectThumbnail entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link TechnicalObjectThumbnailSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((TechnicalObjectThumbnailSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            TechnicalObjectThumbnailViewModel viewModel = new ViewModelProvider(getActivity()).get(TechnicalObjectThumbnailViewModel.class);
